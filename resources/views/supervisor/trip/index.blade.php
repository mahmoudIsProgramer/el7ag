            ...
            <div class="box-tools pull-right">
                <div class="form-group">
                    @if(Auth::guard('supervisor')->user())
                        <a href="{{route('supervisor.trip.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Trip')</a>
                    @else
                              ...
                              <tr>
                                  ...
                                  <td>
                                      @if(Auth::guard('supervisor')->user())
                                          ...
                                          <a class="active"  data-toggle="modal" href="{{route('supervisor.trip.edit',$value->id)}}">
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                              ...
                                                              <a href="{{ route('supervisor.trip.destroy',$value->id) }}">
