...
@section('content-wrapper')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Drivers')</li>
        </ol>
    </section>
@endsection()
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">@lang('admin.View Drivers')</h3>
            <div class="box-tools pull-right">
                <div class="form-group">
                    @if(Auth::guard('company')->user())
                        <a href="{{route('company.driver.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Driver')</a>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      @if(Auth::guard('company')->user())
                                          ...
                                          <a class="active"  data-toggle="modal" href="{{route('company.driver.edit',$value->id)}}">
                                      ...
                                      @endif
                                          ...
                                          @if(Auth::guard('company')->user())
                                              <a class="active"  data-toggle="modal" href="#status-driver{{ $value->id }}">
                                                  <button class="btn btn-warning btn-xs"><i class="fa fa-bar-chart "></i></button>
                                              </a>

                                              <div class="modal fade" id="status-driver{{ $value->id }}" tabindex="-1"
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                              ...
                                                              <a href="{{ route('company.driver.status',$value->id) }}">
                                    ...
                                    {{-- start view  user  --}}
                                    @if(Auth::guard('company')->user()   || Auth::guard('user_vendor')->user()->hasPermission('read_drivers') )
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="box box-primary">
                                                            <div class="box-body box-profile">
                                                                ...
                                                                <h3 class="profile-username text-center"> {!! \App\Driver::find($value->id)->translate(App::getLocale())->name !!}</h3>
                                                                ...
                                                                <ul class="list-group list-group-unbordered">
                                                                    ...
                                                                    @php 
                                                                        $attachments =  \DB::table('attachments')->where('type','driver')->where('user_id',$value->id)->pluck('file_name')->toArray();
                                                                    @endphp
                                                                    <div class="container">
                                                                        @foreach( $attachments   as $file)
                                                                            <div class="row">
                                                                                <div class='col-md-12 m-auto b-3 '>
                                                                                    <img class="img-responsive" alt="" src="{{ image_path('driver', $file) }}" />
                                                                                </div> 
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                    ...
                                    {{-- start delete  --}}
                                    @if(Auth::guard('company')->user()   || Auth::guard('user_vendor')->user()->hasPermission('delete_drivers') )
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('company.driver.destroy',$value->id) }}">
