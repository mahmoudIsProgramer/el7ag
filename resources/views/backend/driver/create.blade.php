    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::guard('company')->user())
                <li ><a href="{{route('company.driver.index')}}"><i class="fa fa-user-secret"></i> @lang('admin.View Drivers')</a></li>

                @elseif(Auth::guard('user_vendor')->user()->hasPermission('read_drivers'))
                    <li ><a href="{{route('company.driver.index')}}"><i class="fa fa-user-secret"></i> @lang('admin.View Drivers')</a></li>

                @else
                <li ><a><i class="fa fa-user-secret disabled"></i> @lang('admin.View Drivers')</a></li>
            @endif
        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.Create data driver')</h3>
                </div>
                {!! Form::open(['url'=>route('company.driver.store'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
