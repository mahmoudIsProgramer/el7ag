    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::guard('company')->user())
                <li ><a href="{{route('admin.company.index')}}"><i class="fa fa-users"></i> @lang('admin.View Supervisors')</a></li>

                @elseif(Auth::guard('user_vendor')->user()->hasPermission('read_supervisors'))
            ...
            @endif
            <li class="active">@lang('admin.Create supervisor')</li>
        </ol>
    </section>
@endsection()
        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.Create data supervisor')</h3>
                </div>
                {!! Form::open(['url'=>route('company.supervisor.store'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="member_id" required autofoucus>
