...
@section('content-wrapper')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Supervisors')</li>
        </ol>
    </section>
@endsection()
            ...
            <div class="box-tools pull-right">
                <div class="form-group">
                    @if(Auth::guard('company')->user())
                        <a href="{{route('company.supervisor.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Supervisor')</a>
                        @elseif(Auth::guard('user_vendor')->user()->hasPermission('red_supervisors'))
                        <a href="{{route('company.supervisor.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Supervisor')</a>
                    @else
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            @endif
                            <td>{!! \App\Member::find($value->member_id)->name !!}</td>
                            <td>
                                 
                                {{-- start upadet  --}}
                                @if(Auth::guard('company')->user()  || Auth::guard('user_vendor')->user()->hasPermission('update_supervisors')    )

                                    <a class="active"  data-toggle="modal" href="{{route('company.supervisor.edit',$value->id)}}">
                                ...
                                {{-- start change status   --}}
                                @if(Auth::guard('company')->user() || Auth::guard('user_vendor')->user()->hasPermission('delete_supervisors'))
                                    <a class="active"  data-toggle="modal" href="#status-supervisor{{ $value->id }}">
                                        <button class="btn btn-warning btn-xs"><i class="fa fa-bar-chart "></i></button>
                                    </a>

                                    <div class="modal fade" id="status-supervisor{{ $value->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('company.supervisor.status',$value->id) }}">
                                ...
                                {{-- end change status   --}}
                                {{-- start view  user  --}}
                                @if(Auth::guard('company')->user()   || Auth::guard('user_vendor')->user()->hasPermission('read_supervisors') )
                                                ...
                                                <div class="modal-body">
                                                    <div class="box box-primary">
                                                        <div class="box-body box-profile">
                                                            ...
                                                            <h3 class="profile-username text-center"> {!! \App\Supervisor::find($value->id)->translate(App::getLocale())->name !!}</h3>
                                                            ...
                                                            <ul class="list-group list-group-unbordered">
                                                                ...
                                                                @php 
                                                                    $attachments =  \DB::table('attachments')->where('type','supervisor')->where('user_id',$value->id)->pluck('file_name')->toArray();
                                                                @endphp
                                                                <div class="container">
                                                                    @foreach( $attachments   as $file)
                                                                        <div class="row">
                                                                            <div class='col-md-12 m-auto b-3 '>
                                                                                <img class="img-responsive" alt="" src="{{ image_path('supervisor', $file) }}" />
                                                                            </div> 
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('company.supervisor.destroy',$value->id) }}">
