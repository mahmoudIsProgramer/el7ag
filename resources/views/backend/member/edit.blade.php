    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::guard('company')->user())
                <li ><a href="{{route('company.member.index')}}"><i class="fa fa-user-circle-o"></i> @lang('admin.View Members')</a></li>
                @elseif(Auth::guard('company')->user()->hasPermission('read_members'))
                    <li ><a href="{{route('company.member.index')}}"><i class="fa fa-user-circle-o"></i> @lang('admin.View Members')</a></li>

                @else
                <li ><a><i class="fa fa-user-circle-o disabled"></i> @lang('admin.View Members')</a></li>
            @endif
            <li class="active">@lang('admin.Edit member')</li>
        </ol>
    </section>
@endsection()
        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.Edit data member')</h3>
                </div>
                {!! Form::open(['url'=>route('company.member.update'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            @foreach(config('translatable.locales') as $locale)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" autofocus value="{{$member->translate($locale)->name}}" name="{{$locale}}[name]" id="exampleInputEmail1" placeholder="@lang('admin.'.$locale.'.companyName')">
                                </div>

                            @endforeach

                                <div class="form-group">
                                    <img src="{{$member->imagePath}}" style="width: 100px;" class="img-thumbnail image-preview" alt="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{$member->mobile}}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="{{$member->ssn}}"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nationality"
                                       value="{!! $member->nationality !!}" id="exampleInputEmail1"
                                       placeholder="@lang('admin.Nationality')">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">@lang('admin.E-mail')</label>
                                <input type="email" class="form-control" name="email" value="{!! $member->email !!}" id="exampleInputEmail1" placeholder="@lang('admin.E-mail')">
                            </div>

                            <div class="form-group">
                                <label  class="col-sm-2 control-label">@lang('Status')</label>
                                {!! Form::select('status',[1=>trans('admin.Active'),0=>trans('admin.In-Active')],
                                $member->status,['class'=>'form-control select2','style'=>'width: 100%;',
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="{{$member->address}}" name="address" id="exampleInputEmail1" placeholder="@lang('admin.Address')">
                            </div>
