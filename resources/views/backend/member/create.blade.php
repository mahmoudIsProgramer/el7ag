    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::guard('company')->user())
                ...
                @elseif(Auth::guard('user_vendor')->user()->hasPermission('read_members'))
                    <li ><a href="{{route('company.member.index')}}"><i class="fa fa-user-circle-o"></i> @lang('admin.View Members')</a></li>

                @else
                <li ><a><i class="fa fa-user-circle-o disabled"></i> @lang('admin.View Members')</a></li>
            @endif
            <li class="active">@lang('admin.Create Member')</li>
        </ol>
    </section>
@endsection()
        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.Create data member')</h3>
                </div>
                {!! Form::open(['url'=>route('company.member.store'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
