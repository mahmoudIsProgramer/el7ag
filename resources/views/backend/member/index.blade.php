...
@section('title',trans('admin.Members'))
...
@section('content-wrapper')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">@lang('admin.View Members')</li>
        </ol>
    </section>
@endsection()
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">@lang('admin.View Members')</h3>
            <div class="box-tools pull-right">
                <div class="form-group">
                    @if(Auth::guard('company')->user())
                        <a href="{{route('company.member.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Member')</a>
                        @elseif(Auth::guard('user_vendor')->user()->hasPermission('red_members'))
                        <a href="{{route('company.member.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"> </i> @lang('admin.Create Member')</a>
                    @else
                        <a  class="btn btn-primary disabled"><i class="fa fa-plus-circle"> </i> @lang('admin.Add Member')</a>
                    @endif
                </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                              ...
                              <tr>
                                  ...
                                  <td>
                                      @if(Auth::guard('company')->user())
                                          ...
                                          <a class="active"  data-toggle="modal" href="{{route('company.member.edit',$value->id)}}">
                                              <button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i></button>
                                          </a>
                                          @elseif(Auth::guard('user_vendor')->user()->hasPermission('update_members'))
                                          <a class="active"  data-toggle="modal" href="{{route('company.member.edit',$value->id)}}">
                                              <button class="btn btn-primary btn-xs"><i class="fa fa-edit "></i></button>
                                          </a>
                                      @else
                                      ...
                                      @endif
                                          ...
                                          @if(Auth::guard('company')->user())
                                              <a class="active"  data-toggle="modal" href="#status-member{{ $value->id }}">
                                                  <button class="btn btn-warning btn-xs"><i class="fa fa-bar-chart "></i></button>
                                              </a>

                                              <div class="modal fade" id="status-member{{ $value->id }}" tabindex="-1"
                                                  ...
                                                  <div class="modal-dialog">
                                                      <div class="modal-content">
                                                          ...
                                                          <div class="modal-footer">
                                                              ...
                                                              <a href="{{ route('company.member.status',$value->id) }}">
                                      ...
                                      @elseif(Auth::guard('user_vendor')->user()->hasPermission('delete_members'))
                                      ...
                                      @endif
                                      {{-- start view  user  --}}
                                @if(Auth::guard('company')->user()   || Auth::guard('user_vendor')->user()->hasPermission('read_members') )
                                            ...
                                            <div class="modal-body">
                                                <div class="box box-primary">
                                                    <div class="box-body box-profile">
                                                        ...
                                                        <h3 class="profile-username text-center"> {!! \App\Member::find($value->id)->translate(App::getLocale())->name !!}</h3>
                                                        ...
                                                        <ul class="list-group list-group-unbordered">
                                                            ...
                                                            @php
                                                                $attachments =  \DB::table('attachments')->where('type','member')->where('user_id',$value->id)->pluck('file_name')->toArray();
                                                            @endphp
                                                                ...
                                                                @foreach( $attachments   as $file)
                                                                    <div class="row">
                                                                        <div class='col-md-12 m-auto b-3 '>
                                                                            <img class="img-responsive"  src="{{ image_path('member', $file) }}" />
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                            ...
                            {{-- start delete  --}}
                            @if(Auth::guard('company')->user()   || Auth::guard('user_vendor')->user()->hasPermission('delete_members') )
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ route('company.member.destroy',$value->id) }}">
