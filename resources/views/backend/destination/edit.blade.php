    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if(Auth::guard('company')->user())
                ...
                @elseif(Auth::guard('company')->user()->hasPermission('read_destination'))
                    <li ><a href="{{route('company.destination.index')}}"><i class="fa fa-user-o"></i> @lang('admin.View Destination')</a></li>

                @else
                <li ><a><i class="fa fa-user-o disabled"></i> @lang('admin.View Destination')</a></li>
            @endif
            <li class="active">@lang('admin.Edit destination')</li>
        </ol>
    </section>
@endsection()
        ...
        <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin.Edit data destination')</h3>
                </div>
                {!! Form::open(['url'=>route('company.destination.update'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}

               <input name="id" value="{!! $destination->id !!}" hidden>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                @foreach(config('translatable.locales') as $locale)
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">@lang('admin.'.$locale.'.DesName')</label>
                                        <input type="text" class="form-control" autofocus value="{{$destination->translate($locale)->name}}" name="{{$locale}}[name]"
                                               id="exampleInputEmail1" placeholder="@lang('admin.'.$locale.'.DesName')">
                                    </div>
                        ...
                        <div class="col-lg-6 col-lg-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                $destination->status,['class'=>'form-control select2','style'=>'width: 100%;' ]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden"  class="form-control" id="lat"
                                       placeholder="@lang('admin.Start Latitude')"  name="lat" value="{!! $destination->lat !!}">



                                <input type="hidden"  class="form-control" id="lng"
                                       name="lng" value="{!! $destination->lng !!}" placeholder="@lang('admin.End Latitude')">
