    ...
    <section class="content">
        ...
        <div class="row">
            <div class="box box-primary">
                ...
                {!! Form::open(['url'=>route('company.trip.update'),'method'=>'post','files'=>true,'role'=>'form','id'=>'formABC']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type = "datetime-local" name = "start_date"  
                                                   value="{{ date('Y-m-d\TH:i:s',strtotime($trip->start_date)) }}"   class="form-control"><br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type = "datetime-local" name = "end_date"  
                                                   value="{{ date('Y-m-d\TH:i:s',strtotime($trip->end_date)) }}"  class="form-control"><br>
