...
class DriverController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['auth:user_vendor','permission:read_drivers'])->only('index');
        $this->middleware(['auth:user_vendor','permission:create_drivers'])->only('create','store');
        $this->middleware(['auth:user_vendor','permission:update_drivers'])->only('edit','update');
        $this->middleware(['auth:user_vendor','permission:delete_drivers'])->only('status','delete');
    }
