...
class SupervisorController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['auth:user_vendor','permission:read_supervisors'])->only('index');
        $this->middleware(['auth:user_vendor','permission:create_supervisors'])->only('create','store');
        $this->middleware(['auth:user_vendor','permission:update_supervisors'])->only('edit','update');
        $this->middleware(['auth:user_vendor','permission:delete_supervisors'])->only('status','delete');
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            Supervisor::create($requestData);

            session()->flash('success',trans('admin.Data has been added successfully'));

            return redirect()->route('user.vendor.supervisor.index');
